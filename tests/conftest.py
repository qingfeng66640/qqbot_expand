...
def make_plugin(
    *,
    ...
    enable_menu_panel_service: bool = False,
    enable_menu_panel_tools: bool = False,
    allow_global_menu_write: bool = False,
    allow_panel_create: bool = False,
    allow_panel_delete: bool = False,
    menu_panel_allowed_operator_openids: list[str] | None = None,
    menu_panel_allowed_group_openids: list[str] | None = None,
    menu_panel_allowed_panel_ids: list[str] | None = None,
    menu_panel_profiles: list[dict[str, Any]] | None = None,
    ...
    features = SimpleNamespace(
        ...
        enable_menu_panel_service=enable_menu_panel_service,
        enable_menu_panel_tools=enable_menu_panel_tools,
        allow_global_menu_write=allow_global_menu_write,
        allow_panel_create=allow_panel_create,
        allow_panel_delete=allow_panel_delete,
        menu_panel_allowed_operator_openids=menu_panel_allowed_operator_openids or [],
        menu_panel_allowed_group_openids=menu_panel_allowed_group_openids or [],
        menu_panel_allowed_panel_ids=menu_panel_allowed_panel_ids or [],
        menu_panel_profiles=menu_panel_profiles or [],
